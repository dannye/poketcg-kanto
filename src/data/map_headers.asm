...
; sgb tilemap, cgb tilemap, initial cgb palette (always 0), sgb palette, final cgb palette, song
	...
	db TILEMAP_PALLET_TOWN,             TILEMAP_PALLET_TOWN_CGB,             PALETTE_0, MAP_SGB_PALS_2,  PALETTE_161,MUSIC_OVERWORLD     ; PALLET_TOWN
	db TILEMAP_VIRIDIAN_CITY_TL,        TILEMAP_VIRIDIAN_CITY_TL_CGB,        PALETTE_0, MAP_SGB_PALS_6,  PALETTE_162,MUSIC_OVERWORLD     ; VIRIDIAN_CITY_TL
	db TILEMAP_VIRIDIAN_CITY_TR,        TILEMAP_VIRIDIAN_CITY_TR_CGB,        PALETTE_0, MAP_SGB_PALS_6,  PALETTE_162,MUSIC_OVERWORLD     ; VIRIDIAN_CITY_TR
	db TILEMAP_VIRIDIAN_CITY_BL,        TILEMAP_VIRIDIAN_CITY_BL_CGB,        PALETTE_0, MAP_SGB_PALS_6,  PALETTE_162,MUSIC_OVERWORLD     ; VIRIDIAN_CITY_BL
	db TILEMAP_VIRIDIAN_CITY_BR,        TILEMAP_VIRIDIAN_CITY_BR_CGB,        PALETTE_0, MAP_SGB_PALS_6,  PALETTE_162,MUSIC_OVERWORLD     ; VIRIDIAN_CITY_BR
	db TILEMAP_PEWTER_CITY_TL,          TILEMAP_PEWTER_CITY_TL_CGB,          PALETTE_0, MAP_SGB_PALS_11, PALETTE_163,MUSIC_OVERWORLD     ; PEWTER_CITY_TL
	db TILEMAP_PEWTER_CITY_TR,          TILEMAP_PEWTER_CITY_TR_CGB,          PALETTE_0, MAP_SGB_PALS_11, PALETTE_163,MUSIC_OVERWORLD     ; PEWTER_CITY_TR
	db TILEMAP_PEWTER_CITY_BL,          TILEMAP_PEWTER_CITY_BL_CGB,          PALETTE_0, MAP_SGB_PALS_11, PALETTE_163,MUSIC_OVERWORLD     ; PEWTER_CITY_BL
	db TILEMAP_PEWTER_CITY_BR,          TILEMAP_PEWTER_CITY_BR_CGB,          PALETTE_0, MAP_SGB_PALS_11, PALETTE_163,MUSIC_OVERWORLD     ; PEWTER_CITY_BR
	db TILEMAP_CERULEAN_CITY_TL,        TILEMAP_CERULEAN_CITY_TL_CGB,        PALETTE_0, MAP_SGB_PALS_2,  PALETTE_164,MUSIC_OVERWORLD     ; CERULEAN_CITY_TL
	db TILEMAP_CERULEAN_CITY_TR,        TILEMAP_CERULEAN_CITY_TR_CGB,        PALETTE_0, MAP_SGB_PALS_2,  PALETTE_164,MUSIC_OVERWORLD     ; CERULEAN_CITY_TR
	db TILEMAP_CERULEAN_CITY_BL,        TILEMAP_CERULEAN_CITY_BL_CGB,        PALETTE_0, MAP_SGB_PALS_2,  PALETTE_164,MUSIC_OVERWORLD     ; CERULEAN_CITY_BL
	db TILEMAP_CERULEAN_CITY_BR,        TILEMAP_CERULEAN_CITY_BR_CGB,        PALETTE_0, MAP_SGB_PALS_2,  PALETTE_164,MUSIC_OVERWORLD     ; CERULEAN_CITY_BR
