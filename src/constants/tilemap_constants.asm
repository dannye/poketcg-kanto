	...
	const TILEMAP_VIRIDIAN_CITY_TL
	const TILEMAP_VIRIDIAN_CITY_TL_CGB
	const TILEMAP_VIRIDIAN_CITY_TR
	const TILEMAP_VIRIDIAN_CITY_TR_CGB
	const TILEMAP_VIRIDIAN_CITY_BL
	const TILEMAP_VIRIDIAN_CITY_BL_CGB
	const TILEMAP_VIRIDIAN_CITY_BR
	const TILEMAP_VIRIDIAN_CITY_BR_CGB
	const TILEMAP_PEWTER_CITY_TL
	const TILEMAP_PEWTER_CITY_TL_CGB
	const TILEMAP_PEWTER_CITY_TR
	const TILEMAP_PEWTER_CITY_TR_CGB
	const TILEMAP_PEWTER_CITY_BL
	const TILEMAP_PEWTER_CITY_BL_CGB
	const TILEMAP_PEWTER_CITY_BR
	const TILEMAP_PEWTER_CITY_BR_CGB
	const TILEMAP_CERULEAN_CITY_TL
	const TILEMAP_CERULEAN_CITY_TL_CGB
	const TILEMAP_CERULEAN_CITY_TR
	const TILEMAP_CERULEAN_CITY_TR_CGB
	const TILEMAP_CERULEAN_CITY_BL
	const TILEMAP_CERULEAN_CITY_BL_CGB
	const TILEMAP_CERULEAN_CITY_BR
	const TILEMAP_CERULEAN_CITY_BR_CGB
